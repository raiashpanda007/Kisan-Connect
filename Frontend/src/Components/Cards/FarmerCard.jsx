...
const FarmerCard = ({ content, isButton,onClick }) => {
  return (
    <div onClick={onClick} className="bg-gradient-to-r from-green-100 via-blue-200 to-purple-300 border-2 border-gray-300 rounded-lg p-8 w-96 shadow hover:shadow-lg transition-shadow duration-200 ease-in-out flex justify-center items-center">
      {isButton ? (
